...
public class JavaApplication {
    public static void main(String[] args) {
        ...
        userService.readUser(user.getId())
                .ifPresent(u -> System.out.println("회원 조회: " + u));

        // 조회 - 다건
        System.out.println("모든 회원 조회: " + userService.readAllUsers());

        // 수정
        userService.updateUser(user.getId(), "정연경", 23, 'F');
        ...
        // 조회를 통해 삭제되었는지 확인
        System.out.println("회원 목록: " + userService.readAllUsers());
        ...
        channelService.readChannel(channel.getId())
                .ifPresent(c -> System.out.println("채널 조회: " + c));
        ...
        // 조회를 통해 삭제되었는지 확인
        System.out.println("채널 목록: " + channelService.readAllChannels());
        ...
        messageService.readMessage(message.getId())
                .ifPresent(m -> System.out.println("메세지 조회: " + m));
        ...
        // 조회를 통해 삭제되었는지 확인
        System.out.println("메세지 목록: " + messageService.readAllMessages());
    }
}